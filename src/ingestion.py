...
def run_ingestion():
    ...
    # Rutas relativas a la raíz del espacio de trabajo (subir 3 niveles desde src)
    root_dir = BASE_DIR.parent.parent.parent
    perfiles_csv = root_dir / "Perfiles Programa de Incubacion.csv"
    responses_csv = root_dir / "Documentos" / "Formularios_Maestros" / "Diagnóstico de Perfil Tecnológico y Competencias Digitales (Respuestas).csv"
